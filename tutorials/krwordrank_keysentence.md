...
```python
from krwordrank.sentence import MaxScoreTokenizer, make_vocab_score
...
sents = keysentence(vocab_score, texts, tokenizer.tokenize, penalty=penalty, diversity=0.3, topk=10)
...
```python
sents = keysentence(vocab_score, texts, tokenizer.tokenize, penalty=penalty, diversity=0.7, topk=10)
